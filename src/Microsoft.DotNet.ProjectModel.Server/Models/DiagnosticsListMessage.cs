...
{
    public class DiagnosticsListMessage: IConvertablePayload
    {
        ...
        public JToken ToJToken(int protocolVersion)
        {
            ...
            {
                throw new ArgumentException($"Unknown protocol version {protocolVersion}");
            }
        }
