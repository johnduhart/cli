...
namespace Microsoft.DotNet.ProjectModel
{
    public class WorkspaceContext
    {
        ...
        private readonly ConcurrentDictionary<string, ProjectContextsCollection> _projectContextsCache
                   = new ConcurrentDictionary<string, ProjectContextsCollection>();
        ...
        {
            return GetProjectContextsCollection(projectPath).ProjectContexts;
        }

        public ProjectContextsCollection GetProjectContextsCollection(string projectPath)
        {
        ...
        private ProjectContextsCollection AddProjectContextEntry(string projectDirectory,
                                                                 ProjectContextsCollection currentEntry)
        {
            if (currentEntry == null)
            {
                // new entry required
                currentEntry = new ProjectContextsCollection();
            }
